...
This directory contains built-in skills that extend MiniUnicorn's capabilities.
...
When skills reference large local documentation or logs, prefer MiniUnicorn's built-in
