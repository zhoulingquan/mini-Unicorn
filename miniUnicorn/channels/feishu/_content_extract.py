"""Feishu message content extraction helpers.

Pure functions for extracting text/image-key representations from the various
Feishu/Lark message payload shapes (rich-text post, share cards, interactive
CardKit cards). Extracted from ``channel.py`` to keep that module focused on
the channel class and its WebSocket lifecycle.
"""
