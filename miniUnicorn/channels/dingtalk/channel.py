...
from miniUnicorn.security.network import validate_resolved_url, validate_url_target
...
class miniUnicornDingTalkHandler(CallbackHandler):
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to miniUnicorn via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    # _IMAGE_EXTS / _AUDIO_EXTS / _VIDEO_EXTS 由 miniUnicorn.channels._media_common
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "miniUnicorn Reply"},
        )
