"""JSON Schema fragment types: all subclass :class:`~miniUnicorn.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~miniUnicorn.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~miniUnicorn.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~miniUnicorn.agent.tools.base.Schema`.
...
from miniUnicorn.agent.tools.base import Schema
