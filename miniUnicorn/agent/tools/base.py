...
class Schema(ABC):
    ...
    Concrete types live in :mod:`MiniUnicorn.agent.tools.schema`; all implement
...
class Tool(ABC):
    ...
    def compactable(self) -> bool:
        """Whether old tool results can be summarized by microcompact to save context."""
        return False

    @property
    def importance(self) -> float:
        """Importance score 0.0-1.0. 1.0 = never drop, 0.0 = freely compactable."""
        return 0.5
