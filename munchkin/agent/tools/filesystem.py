...
from munchkin.agent.tools.file_state import FileStates, _hash_file, current_file_states
from munchkin.agent.tools.path_utils import resolve_workspace_path
...
from munchkin.security.workspace_access import current_tool_workspace
from munchkin.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from munchkin.utils.document import extract_text
