...
from munchkin.utils.file_edit_events import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set MUNCHKIN_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("MUNCHKIN_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (MUNCHKIN_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded MUNCHKIN_LLM_TIMEOUT_S.
