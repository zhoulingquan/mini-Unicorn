...
from munchkin.agent import context as agent_context
from munchkin.agent import model_presets as preset_helpers
from munchkin.agent.autocompact import AutoCompact
from munchkin.agent.context import ContextBuilder
from munchkin.agent.hook import AgentHook, CompositeHook
from munchkin.agent.memory import Consolidator, Dream
from munchkin.agent.progress_hook import AgentProgressHook
from munchkin.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from munchkin.agent.subagent import SubagentManager
from munchkin.agent.tools.context import RequestContext, bind_request_context, reset_request_context
from munchkin.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
...
from munchkin.command import CommandContext, CommandRouter, register_builtin_commands
from munchkin.config.schema import AgentDefaults, ModelPresetConfig
...
from munchkin.session.webui_turns import (
    WebuiTurnCoordinator,
    build_bus_progress_callback,
    mark_webui_session,
)
from munchkin.utils.document import extract_documents, reference_non_image_attachments
from munchkin.utils.helpers import image_placeholder_text
from munchkin.utils.helpers import truncate_text as truncate_text_fn
from munchkin.utils.llm_runtime import LLMRuntime
...
if TYPE_CHECKING:
    from munchkin.config.schema import (
        ChannelsConfig,
        ToolsConfig,
    )
...
class AgentLoop:
    ...
    def __init__(
        ...
        # MUNCHKIN_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("MUNCHKIN_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    def _set_tool_context(
        ...
        from munchkin.agent.tools.context import ContextAware
        ...
        *on_stream_end(resuming)*: called when a streaming session finishes.
        ...
        try:
            result = await self.runner.run(AgentRunSpec(
                ...
                # Sustained goals may legitimately exceed MUNCHKIN_LLM_TIMEOUT_S; idle stall
                # is still capped by MUNCHKIN_STREAM_IDLE_TIMEOUT_S in streaming providers.
