...
if TYPE_CHECKING:
    from munchkin.agent.tools.cli_apps import CliAppsToolConfig
    from munchkin.agent.tools.self import MyToolConfig
    from munchkin.agent.tools.shell import ExecToolConfig
    from munchkin.agent.tools.web import WebToolsConfig
...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from munchkin.providers.base import GenerationSettings
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.munchkin/workspace"
    ...
    bot_name: str = "Munchkin"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class ToolsConfig(Base):
    ...
    web: WebToolsConfig = Field(default_factory=lambda: _lazy_default("munchkin.agent.tools.web", "WebToolsConfig"))
    exec: ExecToolConfig = Field(default_factory=lambda: _lazy_default("munchkin.agent.tools.shell", "ExecToolConfig"))
    cli_apps: CliAppsToolConfig = Field(default_factory=lambda: _lazy_default("munchkin.agent.tools.cli_apps", "CliAppsToolConfig"))
    my: MyToolConfig = Field(default_factory=lambda: _lazy_default("munchkin.agent.tools.self", "MyToolConfig"))
...
class Config(BaseSettings):
    """Root configuration for Munchkin."""
    ...
    model_config = ConfigDict(env_prefix="MUNCHKIN_", env_nested_delimiter="__")
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from munchkin.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
    ...
    from munchkin.agent.tools.self import MyToolConfig
    from munchkin.agent.tools.shell import ExecToolConfig
    from munchkin.agent.tools.web import WebFetchConfig, WebSearchConfig, WebToolsConfig
