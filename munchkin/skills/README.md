...
This directory contains built-in skills that extend Munchkin's capabilities.
...
When skills reference large local documentation or logs, prefer Munchkin's built-in
