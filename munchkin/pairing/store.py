...
Persistent storage at ``~/.munchkin/pairing.json`` keeps approved senders
...
from munchkin.config.paths import get_data_dir
from munchkin.utils.helpers import _write_text_atomic
