"""High-level programmatic interface to Munchkin."""
...
from munchkin.agent.hook import AgentHook, SDKCaptureHook
...
class Munchkin:
    """Programmatic facade for running the Munchkin agent.
